...
// get, put, delete: have their own http functions
...
// MKCOL, MOVE, COPY are not native. Use either app.use or app.all.
// app.all rather than app.use is typical when replacing verbs or routing
